...
Public Class clsTrabajador
    ...
    Public Function listarTrabajadoresHistorico(rutContratista As String, idCarpeta As Integer) As DataTable
        ...
        Try
            Dim ds As New DataSet()
            Dim sql As String = "SP_SAEC_ListarTrabajadoresHistorico '" & rutContratista & "','" & idCarpeta & "'"
            con.Open()
    ...
    Public Function listarDocumentosTrabajadorHistorico(idTrabajador As Integer, rutContratista As String, idCarpeta As Integer) As DataTable

        Dim con As New SqlConnection(Conexion.strSQLSERVER)
        Try
            Dim ds As New DataSet()
            Dim sql As String = "SP_SAEC_ListarDocumentosTrabajadorHistorico'" & idTrabajador & "','" & rutContratista & "','" & idCarpeta & "'"
            con.Open()
        ...
        End Try
    End Function
    Public Function listarTrabajadoresHistorico(idCarpeta As Integer) As DataTable

        Dim con As New SqlConnection(Conexion.strSQLSERVER)
        Try
            Dim ds As New DataSet()
            Dim sql As String = "SP_SAEC_ListarTrabajadoresHistoricoATI '" & idCarpeta & "'"
            con.Open()
    ...
    End Function
    Public Function listarDocumentosTrabajadorHistorico(idTrabajador As Integer, idCarpeta As Integer) As DataTable

        Dim con As New SqlConnection(Conexion.strSQLSERVER)
        Try
            Dim ds As New DataSet()
            Dim sql As String = "SP_SAEC_ListarDocumentosTrabajadorHistoricoATI'" & idTrabajador & "','" & idCarpeta & "'"
            con.Open()
