Public Class TrabajadorHistorico
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Dim listaDocumentosTrabajador As DataTable = trabajador.listarDocumentosTrabajadorHistorico(Session("idTrabajador"), Session("rutContratista"), Session("idCarpetaHistorico"))
