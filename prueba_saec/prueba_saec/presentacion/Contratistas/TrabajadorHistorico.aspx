<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="TrabajadorHistorico.aspx.vb" Inherits="prueba_saec.TrabajadorHistorico" %>
                    ...
                    <form id="form15" runat="server" class="md-form">
                        ...
                        <div class="card shadow mb-4">
                            <div class="card-header py-3">
                                <div class="row">
                                    <div class="col-4">
                                        <h4 class="m-0 font-weight text-primary">Trabajador:                                       
                                            <asp:Label ID="lblTrabajador" runat="server" Text="Label" class="m-0 font-weight text-primary"></asp:Label></h4>
