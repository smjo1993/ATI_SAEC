        ...
        For Each rol In Session("roles")
            ...
            If rol.getIdRol() = 3 Then
                ...
                For Each fila As DataRow In listaEmpresas.Rows
                    ...
                    tarjeta = tarjeta & "              </div> "
                    tarjeta = tarjeta & "              <div Class=""col-auto""> "
                    tarjeta = tarjeta & "              <a href=""https://localhost:44310/presentacion/funcionarios%20ATI/CrearListaDocumentacion.aspx?i=" + idCodificada + """ class=""fas fa-comments fa-2x text-" + color + """></a>"
                    tarjeta = tarjeta & "              </div> "
                    tarjeta = tarjeta & "              <div Class=""col-1""> "
                    tarjeta = tarjeta & "              </div> "
                    tarjeta = tarjeta & "              <div Class=""col-auto""> "
