        ...
        If listaNotificaciones.Rows.Count > 0 Then
            ...
            For Each fila As DataRow In listaNotificaciones.Rows
                ...
                If estadoComentario = "no leido" Then
                    ...
                    tarjeta = tarjeta & "   <a class=""dropdown-item d-flex align-items-center"" href=""../Contratistas/verComentarios.aspx?i=" + idDocCodificado + "&n=" + idAreaCodificada + "&o=" + idCarpetaCodificada + "&p=" + RutCodificado + ">"
